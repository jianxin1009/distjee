...
8. 实体类可以继承使用,可以参考测试代码中的`net.distjee.common.dao.mapper.model.UserLogin2`类.
...
```xml
<mappers>
  <mapper class="net.distjee.common.dao.mapper.mapper.CountryMapper" />
  <mapper class="net.distjee.common.dao.mapper.mapper.UserInfoMapper" />
  <mapper class="net.distjee.common.dao.mapper.mapper.UserLoginMapper" />
</mappers>
```
...
<bean class="net.distjee.common.dao.spring.mapper.MapperScannerConfigurer">
  ...
  <property name="markerInterface" value="net.distjee.common.dao.mapper.common.Mapper"/>
</bean>
```
