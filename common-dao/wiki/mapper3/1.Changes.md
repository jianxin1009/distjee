...
```xml
<bean class="net.distjee.common.dao.mapper.mapperhelper.MapperInterceptor">
...
如果我自己的整个项目中只用到了`Mapper<T>`接口，那么只配置一个`mappers=net.distjee.common.dao.mapper.common.Mapper`即可。
