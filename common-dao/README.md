#MyBatis通用Mapper3
>此文档是官方文档，为了便于将其修改及参考他的代码，所以把代码修改包名后直接引入了进来
>使用使用方式直接参考测试类学习即可，使用方式直接看如下几个类：
> * net.distjee.common.dao.mapper.test.able.TestBasicAble
> * net.distjee.common.dao.mapper.test.example.TestDeleteByExample
> * net.distjee.common.dao.mapper.test.example.TestSelectByExample
> * net.distjee.common.dao.mapper.test.example.TestSelectCountByExample
> * net.distjee.common.dao.mapper.test.example.TestUpdateByExample
> * net.distjee.common.dao.mapper.test.example.TestUpdateByExampleSelective
